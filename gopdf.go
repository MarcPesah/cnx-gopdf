...
func (gp *GoPdf2) Start(config Config) {
	...
	catalog.init(func() *GoPdf2 {
		return gp
	})
	pages := new(PagesObj)
	pages.init(func() *GoPdf2 {
		return gp
	})
	gp.outlines = new(OutlinesObj)
	gp.outlines.init(func() *GoPdf2 {
		return gp
	})
...
func (gp *GoPdf2) compilePdf(w io.Writer) error {
	gp.prepare()
	err := gp.Close()
	if err != nil {
		return err
...
func (gp *GoPdf2) SetProtection(permissions int, userPass []byte, ownerPass []byte) {
...
func (gp *GoPdf2) isUseProtection() bool {
	return gp.config.Protection.UseProtection
}

func (gp *GoPdf2) createProtection() *PDFProtection {
...
func (gp *GoPdf2) protection() *PDFProtection {
	return gp.pdfProtection
}

func (gp *GoPdf2) prepare() {
...
func (gp *GoPdf2) xref(w io.Writer, xrefbyteoffset int, linelens []int, i int) error {
...
func (gp *GoPdf2) writeInfo(w io.Writer) {
...
func (gp *GoPdf2) formatXrefline(n int) string {
	str := strconv.Itoa(n)
	for len(str) < 10 {
		str = "0" + str
	}
...
func (gp *GoPdf2) addExtGStateObj(extGStateObj *ExtGStateObj) (index int, err error) {
	extGStateObj.init(func() *GoPdf2 {
		return gp
	})
